...
<div class="container">
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-table'></i>Add: <span class='fw-300'>Plot</span>
        </h1>
    </div>
    <div class="row">
        <form method="post" action="{{ route('agent.plots.store') }}">
            @csrf
            <div class="form-row">
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="plotname" value="{{ old('total_price') }}" class="form-control" type="number" name="total_price">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="plottype">Down Payment</label>
                        <input id="plotname" value="{{ old('downpay') }}" class="form-control" type="number" name="downpay">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="plottype">Installment Amount</label>
                        <input id="plotname" value="{{ old('installmentpay') }}" class="form-control" type="number" name="installmentpay">
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-2 ml-auto">
                    <button type="submit" id="savePlotbtn" value="{{ old('name') }}" {{ old('name') == '' ? 'disabled' : ''  }}  class="btn btn-primary btn-block mt-4">Save</button>
                </div>
            </div>
        </form>
        <div class="col-md-12">
