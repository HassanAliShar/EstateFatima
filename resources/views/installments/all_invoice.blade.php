                    ...
                    <table class="table mt-5">
                        ...
                        <tbody>
                            ...
                            @foreach ($invoice->bookings as $booking)
                                ...
                                @endphp
                            @endforeach
                            @foreach ($invoice->installments as $row)
                                <tr>
                                ...
                                @php
                                    $count ++;
                                    $subtotal +=$row->installment_amount;
                                @endphp
                            @endforeach
                        </tbody>
                    </table>
                ...
                <table class="table table-clean">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">{{ $subtotal+$down_payment }}</td>
                        </tr>
                        <tr>
                            <td><strong>DownPayment</strong></td>
                            <td class="text-right">{{ $invoice->booking->down_payment ?? 0.00 }}</td>
                        </tr>
