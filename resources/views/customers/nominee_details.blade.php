                ...
                <div class="panel-content">
                    <div class="container">
                        <div class="row">
                            ...
                            <form method="post" action="{{ route('admin.updaate_nominee') }}" enctype="multipart/form-data">
                                <div class="form-row">
                                    @csrf
                                ...
                                <div class="form-row mt-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input id="MobileNumber" data-inputmask="'mask': '9999-9999999'" value="{{ $customer_info->mobile_no }}" class="form-control" type="text" name="mobile_no" >
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
